...
@NgModule({
  entryComponents: [CreateUpdateVendedorModalComponent, ModalConfirmationComponent, YesNoModalComponent, PreviewVendedorModalComponent, PreviewClienteModalComponent, CreateUpdateClienteModalComponent, PreviewAdministradorModalComponent, CreateUpdateAdministradorModalComponent],
  declarations: [VendedoresViewComponent, ClientesViewComponent, CreateUpdateVendedorModalComponent, PreviewVendedorModalComponent, PreviewClienteModalComponent, CreateUpdateClienteModalComponent, AdministradoresViewComponent, PreviewAdministradorModalComponent, CreateUpdateAdministradorModalComponent],
  imports: [
    CommonModule,
