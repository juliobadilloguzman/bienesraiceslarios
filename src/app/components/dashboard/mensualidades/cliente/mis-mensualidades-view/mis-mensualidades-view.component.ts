...
@Component({
  selector: 'app-mis-mensualidades-view',
  templateUrl: './mis-mensualidades-view.component.html',
  styleUrls: ['./mis-mensualidades-view.component.scss']
})
export class MisMensualidadesViewComponent implements OnInit {
